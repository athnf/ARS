...
<?php $__env->startSection('header'); ?>
    <?php echo e('Edit Penerbangan: ' . $flight->flight_number); ?>
...
<?php $__env->startSection('admin_content'); ?>
    ...
    <form action="<?php echo e(route('admin.flights.update', $flight)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="flight_number" id="flight_number" 
                       value="<?php echo e(old('flight_number', $flight->flight_number)); ?>" required 
            ...
            <div>
                ...
                <input type="text" name="airline" id="airline" 
                       value="<?php echo e(old('airline', $flight->airline)); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="aircraft_type" id="aircraft_type" 
                       value="<?php echo e(old('aircraft_type', $flight->aircraft_type)); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                <label for="capacity" class="block text-sm font-medium text-gray-700">Kapasitas Kursi</label>
                <input type="number" name="capacity" id="capacity" 
                       value="<?php echo e(old('capacity', $flight->capacity)); ?>" required min="10" 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="departure_city" id="departure_city" 
                       value="<?php echo e(old('departure_city', $flight->departure_city)); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                ...
                <input type="text" name="arrival_city" id="arrival_city" 
                       value="<?php echo e(old('arrival_city', $flight->arrival_city)); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="departure_airport_code" id="departure_airport_code" 
                       value="<?php echo e(old('departure_airport_code', $flight->departure_airport_code)); ?>" required maxlength="3" 
            ...
            <div>
                ...
                <input type="text" name="arrival_airport_code" id="arrival_airport_code" 
                       value="<?php echo e(old('arrival_airport_code', $flight->arrival_airport_code)); ?>" required maxlength="3" 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm uppercase">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="datetime-local" name="scheduled_departure" id="scheduled_departure" 
                       value="<?php echo e(old('scheduled_departure', $flight->scheduled_departure?->format('Y-m-d\TH:i'))); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                ...
                <input type="datetime-local" name="scheduled_arrival" id="scheduled_arrival" 
                       value="<?php echo e(old('scheduled_arrival', $flight->scheduled_arrival?->format('Y-m-d\TH:i'))); ?>" required 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4">
            <div>
                ...
                <input type="number" name="base_price" id="base_price" 
                       value="<?php echo e(old('base_price', $flight->base_price)); ?>" required min="0" step="1000" 
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
        ...
        <div class="flex justify-start pt-4">
            ...
            <a href="<?php echo e(route('admin.flights.index')); ?>" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition duration-150">
                Batal
            </a>
        </div>
    </form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\azhif\Downloads\airline-reservation-system\resources\views/admin/flights/edit.blade.php ENDPATH**/ ?>